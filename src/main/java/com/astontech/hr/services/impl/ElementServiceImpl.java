...
public class ElementServiceImpl implements ElementService
{
    ...
    @Override
    public Integer countByElementName(String elementName) {
        return elementRepository.countByElementName(elementName);
    }

    @Override
    public Integer deleteByElementName(String elementName) {
        return elementRepository.deleteByElementName(elementName);
    }
}
