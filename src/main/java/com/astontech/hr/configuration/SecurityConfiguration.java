...
{
    //values tied to application.properties
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception
    {
        ...
        //in memory authentication, not acceptable in production environment
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception
    {
        ...
        else if(authenticationMethod.equals("IN_MEMORY"))
        {
            httpSecurity
                    ...
                    //.authorizeRequests().antMatchers("/").permitAll() //allows anyone to access anything
